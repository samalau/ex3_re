...
/* MACROS */				 			 /* GENERAL */
		...
		#define         UNSELECTED 	         0		   // menu unselected

							 					/* MENU OPTIONS */
		#define	             	 addOne           1  	    	  // task/menu choice 1: single day entry
		#define		               addAll           2              // task/menu choice 2: full day entry
		#define		                 stats           3              // task/menu choice 3: daily stats
		#define		                  print 	     4 	            // task/menu choice 4: print data
		#define	                 insights	  	   5		      // task/menu choice 5: overall insights
		#define	   		  	  	    deltas 		    6  	           // task/menu choice 6: average deltas
		#define		    			  done          7  		       // menu choice 7: exit

						    				/* MEASUREMENTS */
		#define 	   DAYS_IN_YEAR      365		// index: 0 to 364
		#define   NUM_OF_BRANDS          5		  // number of car brands
		#define		 BRANDS_NAMES         15	   // max brand name length
		#define      NUM_OF_TYPES          4	    // number of car types
		#define         TYPES_NAMES         10		 // max type name length


/* GLOBAL INTEGER VARIABLES */
	int menuChoice;						// current main menu selection
	int earliestDay = NONE;			// earliest entered day overall
	int	latestDay = NONE;		     // latest entered day overall	
